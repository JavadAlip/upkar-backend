...
router.post(
  '/create-plot-layout',
  AdminToken,
  upload.fields([{ name: 'mainImage', maxCount: 1 }, { name: 'icons' }]),
  createPlotLayout
);

router.put(
  '/update-plot-layout/:id',
  AdminToken,
  upload.fields([
    { name: 'mainImage', maxCount: 1 },
...
router.delete('/delete-plot-layout/:id', AdminToken, deletePlotLayout);
