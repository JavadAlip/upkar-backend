...
import { createCareerMain, getAllCareerMain, updateCareerMain, deleteCareerMain } from "../../controllers/careersPage/careerMainController.js";
import { createCareerImages, getCareerImages, updateCareerImages, deleteCareerImages } from "../../controllers/careersPage/careerImagesController.js";
import { createWhyJoinUs, getAllWhyJoinUs, updateWhyJoinUs, deleteWhyJoinUs } from "../../controllers/careersPage/whyJoinusController.js";
...
//career images
router.post("/create-career-images", AdminToken, upload.array("images"), createCareerImages);
router.get("/get-all-career-images", getCareerImages);
router.put("/update-career-images/:id", AdminToken, upload.array("images"), updateCareerImages);
